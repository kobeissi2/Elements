...
internal class ElementAdapter(private val elements: List<Element>, private val listener: ElementListener) :
    ...
    override fun onBindViewHolder(holder: ElementViewHolder, position: Int) = (holder.itemView as ElementView).run {
